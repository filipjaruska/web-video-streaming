...
export default function VideoPage({ params }: { params: Promise<{ video: string }> }) {
    const API_URL = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5180'
    const [resolvedParams, setResolvedParams] = useState<{ video: string } | null>(null)
    ...
    const videoFileName = resolvedParams ? `${resolvedParams.video}.mp4` : ''
